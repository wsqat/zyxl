...
<!--            </div>-->
        ...
        <div class="xm9">
            ...
            <div class="alert">
				...
				if($_SESSION["u_fb"]==1)
    				{
                            //button bg-dot icon-code
                        echo "发布人员</p><a class='button border-main icon-file' href='../admin/publish.php'>招生简章</a> ";
                        echo "<a class='button border-main icon-file' href='../admin/addlink.php'>学校官网</a> ";
    				    echo "<a class='button border-main icon-file' href='../admin/plan.php'>招生计划</a> ";

    				}
    			if($_SESSION["u_sh"]==1)
    				{
    				echo "审核人员</p><a class='button bg-main icon-download' href='contentadmin.php'> 简章审核</a> ";
                    echo "<a class='button bg-main icon-download' href='linkVerify.php'> 链接审核</a> ";
                    echo "<a class='button bg-main icon-download' href='planVerify.php'> 计划审核</a> ";
    				}
    			if($_SESSION["user_role"]==10)
    				{
                    echo "超级管理员</p>"; 
...
//    				echo "<a class='button bg-main icon-download' href='contentadmin.php'> 审核文章</a> ";
			...
			<div class="panel">
                ...
                <table class="table">
                    ...
                    <tr><td align="right">数据库：</td><td>MYSQL/<?php echo mysql_get_server_info(); ?></td><td align="right"></td><td></td></tr>
                </table>
            </div>
        </div>
    </div>

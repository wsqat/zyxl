<?php /* Smarty version 2.6.18, created on 2015-04-06 16:06:37
         compiled from admin_reply.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<input name="liuyan_id" type="hidden" value="<?php echo $this->_tpl_vars['liuyandata']['liuyan_id']; ?>
">
        ...
        <tbody><tr>
          <td bgcolor="#FFFFFF"><table width="100%" cellspacing="1" cellpadding="5" border="0" bgcolor="#e0e0e0" align="center">
              <tbody><tr bgcolor="#dfdfdf">
                ...
                <td bgcolor="#FEFBF8" align="left"><?php echo $this->_tpl_vars['liuyandata']['liuyan_title']; ?>
</td>
              </tr>
              <tr bgcolor="#dfdfdf">
                <td valign="top" height="25" bgcolor="#FFFFFF" align="right">咨询内容： </td>
                <td bgcolor="#FFFFFF" align="left" style="line-height:200%;"><?php echo $this->_tpl_vars['liuyandata']['liuyan_content']; ?>
</td>
              </tr>
              <tr bgcolor="#efefef">
                ...
                <td bgcolor="#FFFFFF"><table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tbody><tr bgcolor="#efefef">
                      <td align="left" bgcolor="#FFFFFF"><?php echo $this->_tpl_vars['liuyandata']['liuyan_name']; ?>
</td>
                      <td width="25%" bgcolor="#FFFFFF" align="right">咨询时间：</td>
                      <td width="30%" bgcolor="#FFFFFF"><?php echo $this->_tpl_vars['liuyandata']['liuyan_time']; ?>
</td>
              ...
              <tr id="manageRe" bgcolor="#dfdfdf">
                  ...
                  <td bgcolor="#FFFFFF" align="center"><table width="97%" cellspacing="0" cellpadding="0" border="0">
                        <tbody><tr>
                          ...
                          <textarea name="reply_content" id="textarea" ><?php echo $this->_tpl_vars['liuyandata']['reply_content']; ?>
</textarea></td><td width="24%" height="40" align="right" style="line-height:20px;"><input type="submit" name="button" id="button" value="提交"></td>
                        </tr>
                  </tbody></table></td>
                </tr>
          </tbody></table></td>

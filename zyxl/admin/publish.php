...
//							echo "<li><a href='../webadmin/systeming.php'>后台管理</a></li>";
        ...
        <div class="admin-bread">
            ...
            <ul class="bread">
                ...
                <li><a href="../webadmin/content.php">内容管理</a></li>
            </ul>
        </div>
    </div>
</div>
<div class="admin">
	...
	<form action="posteddata.php" method="post" enctype="multipart/form-data">
		<p>
			...
			<input type="submit" value="发布" class="button bg-main"  ></p>
			</label>
			...
			<?php //echo $_SESSION["user_role"];?>
				...
				if($_SESSION["u_fb"]==1)
					{	
						...
						echo "<option value='3'>招生简章</option></select>";
						//echo "<option value='4'>招生计划</option>";
					}
